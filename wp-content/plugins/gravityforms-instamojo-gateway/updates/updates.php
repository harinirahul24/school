...
class GF_Instamojo_License_Updates {

	const SECRET_KEY = '5b2e2491cc5129.56732842';
	const SERVER_URL = 'https://wpgateways.com';
	const LONG_NAME = 'Gravity Forms Instamojo Gateway';
	const SHORT_NAME = 'Gravity Forms Instamojo';
	const VAR_IDS = '12377,12379,12381';
	const PLUGIN_SLUG = 'gravityforms-instamojo-gateway';
	const PLUGIN_FILE = 'instamojo.php';

	private static $_instance = null;

	public static function get_instance() {
		if ( self::$_instance == null ) {
			self::$_instance = new GF_Instamojo_License_Updates();
		}
...
GF_Instamojo_License_Updates::get_instance();