...
if ( ! class_exists( 'SP_EAP_Field_wp_editor' ) ) {
    ...
    // phpcs:ignore
			echo '<textarea name="' . esc_attr( $this->field_name() ) . '"' . $this->field_attributes( $attributes ) . $editor_height . '>' . wp_kses( nl2br( htmlentities( $this->value, ENT_QUOTES, 'UTF-8' ) ), apply_filters( 'sp_ea_description_allow_tags', $allowed_tags ) ) . '</textarea>';
