...
<article id="post-<?php the_ID() ?>" <?php post_class( $post_classes ) ?>>
	...
	echo custom_presscore_new_post_navigation();
	if (get_field('event_date')) {
		$event_date_object = DateTime::createFromFormat('d-m-Y', get_field('event_date'));
		if ($event_date_object->getTimestamp() <= time()) {
			echo do_shortcode('[WebinarArchive]');
