...
function optionsframework_load_styles() {
	...
	wp_register_style( 'the7-microwidgets-icons', PRESSCORE_THEME_URI . '/fonts/icomoon-the7-microwidgets-16x16/style.css', false, THE7_VERSION );
	...
	the7_register_style( 'the7-options', PRESSCORE_ADMIN_URI . '/assets/css/options', array( 'thickbox', 'wp-color-picker', 'the7-select-2', 'dt-awsome-fonts', 'the7-microwidgets-icons' ) );
