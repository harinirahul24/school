...
define('WP_HOME','http://staging.hfnschools.org');
define('WP_SITEURL','http://staging.hfnschools.org');
...
define('DB_NAME', 'stghfnschool');

/** MySQL database username */
define('DB_USER', 'hfnschooluser');

/** MySQL database password */
define('DB_PASSWORD', 'hfnschool@hfn');
